<template>
  <div class="page">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="详情图片" prop="content">
        <Uploader :backImg="ruleForm.content" :limitNum="1" @handSubmit="imgSubmit2" @handRemove="imgRemove2"></Uploader>
      </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods:{
      async fetchData(){
        let res=await fetchCaseDetail({id:this.ruleForm.id})
